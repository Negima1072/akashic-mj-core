...
function hule_mianzi_jiulian(shoupai: Shoupai, hulepai: Pai): Hulexing[] {
  ...
  if (mianzi != "_") {
    ...
    for (let n = 1; n <= 9; n++) {
      ...
      let n_pai = n == parseInt(hulepai[1]) ? bingpai[n] - 1 : bingpai[n];
...
function get_hupai(
  ...
  let pre_hupaiY = pre_hupai as Yiman<string>[];
